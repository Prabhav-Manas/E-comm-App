export const environment = {
  production: true,
  baseUrl: 'https://e-comm-app-ukeo.onrender.com/api/user',
  wildRoute: 'https://e-comm-app-ukeo.onrender.com/api/invalid-url',
  myCart: 'https://e-comm-app-ukeo.onrender.com/api/cart',
  checkout: 'https://e-comm-app-ukeo.onrender.com/api/checkout',
